...
( 
  ...
  CONSTRAINT "PK_PROPERTY" PRIMARY KEY ("P_KEY", "P_TYPE"),
  CONSTRAINT "PROPERTY_PT" FOREIGN KEY ("P_TYPE") REFERENCES "PROPERTY_TYPE" ("PT_ID"),
  CONSTRAINT "PROPERTY_JIR" FOREIGN KEY ("P_JIRA") REFERENCES "JIRA" ("J_ID")
);